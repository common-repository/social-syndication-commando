...
class SSCTwitter extends WP_List_Table {
	...
	public function column_profile_image($item) {
		$actions = array(
		'delete'    => sprintf('<a href="?page=%s&ssctwitterdelete=%s">Delete</a>',$_REQUEST['page'],$item['id']),
		'follow'    => sprintf('<a href="?page=%s&ssctwitterfollow=%s">Follow</a>',
